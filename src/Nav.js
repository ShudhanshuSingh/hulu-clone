...
function Nav({setSelectedOptions}) {
    return (
        <div className="nav">
            ...
            <h2 onClick={()=>setSelectedOptions(requests.fetchActionMovie)}>Action</h2>
            ...
            <h2 onClick={()=>setSelectedOptions(requests.fetchHorrorMovies)}>Animation</h2>
            <h2 onClick={()=>setSelectedOptions(requests.fetchTV)}>Movie</h2>
